...
def run_tests():
    ...
    # Test : Absence de valeurs manquantes dans le fichier CSV
    ...
    # Test : Absence de doublons dans le fichier CSV
    ...
    # Test : Les types des champs sont corrects
    ...
    # Test: Nbr de documents MongoDB = nombre de lignes dans CSV
    ...
    # Test : Chaque champ attendu est présent dans tous les documents
    ...
    # Test : Absence de doublons basé sur les champs "name" et "date_of_admission"
    ...
    # Test : Absence de valeurs manquantes (nulle ou vide)
